...
import org.json.*;
public class NetRest {

	
	public void NetRestGet()
	{
	 try {

			URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=London&&mode=xml&&APPID={56a392acfe9530330af0ca6840e1cb9a}");
